  ...
  return (
    <div>
      ...
      <Typography className="paragraph">
        ...
        nombra, solo se dice que los Aztecas llegan al lago Texcoco y comienzan
        una campaña militar abrazadora y de expansionismo
      </Typography>
      <Typography className="subtitles" variant="h6">
        La triple alianza
      </Typography>
      <Typography className="paragraph">
        ...
        por Mexicas,Texcoco y Tlacopan
      </Typography>
      <Typography className="subtitles" variant="h6">
        Imposición cultural
      </Typography>
      ...
      <Typography className="paragraph">
        ...
        materiales didacticos de mostrar al imperio como un bloque perfecto, con
        todo el territio dentro de el sin ningun enclave, siendo todo controlado
        por ellos, cosa en la que se cae por la conveniencia de no señalar que
        varios lugares dentro del territorio no fueron nunca subyugados.
      </Typography>
      <Typography className="subtitles" variant="h6">
        Conquista (tributo)
      </Typography>
