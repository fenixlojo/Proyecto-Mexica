  ...
  return (
    <div>
      ...
      <Typography className="paragraph">
        ...
        el esta muy ligado al mitos y leyendas, de todas formas, si tenemos que
        precisar un lugar este seria cerca de donde el historiador mexicano
        Alfredo Chavero despues de años de investigación concluyo que podía
        llegar a encontrarse, en Nayarit , estando mucho mas cerca del lago
        Texcoco que lo que propone el video.
      </Typography>
      <Typography className="subtitles" variant="h6">
        Tenochtitlan
      </Typography>
      <Typography className="paragraph">
        ...
        avistamiento que su Dios Huitzilopochtli da como la señal de que
        encontraron su tierra prometida. No se nombre a Huitzilopochtli, y no he
        encontrado ninguna fuente que hable de este sacrificio a una princesa de
        una nacion vecina. Lo mas cercano es el sacrificio de la princesa
        Acolhua , este se dio despues de que fundaran Tenochtitlan , y ademas
        ella era Mexica, no de otro pueblo.
      </Typography>
      <Typography className="subtitles" variant="h6">
        Reinos libres
      </Typography>
      ...
      <Typography className="paragraph">
        ...
        que hasta sus dioses eran tributarios.
      </Typography>
      <Typography className="subtitles" variant="h6">
      ...
      <Typography className="paragraph">
        ...
        mezcla entre religión y conocimiento, asi como su gobierno era
        teocratico, su conocimiento tambien, se regia por la religión.
      </Typography>
    </div>
  );
}
